...
// Função para abrir modal de senha, guarda ação e id do colaborador (se houver)
function abrirModalSenha(acao, colaboradorId = null) {
  acaoAtual = acao;
  inputSenha.value = "";
  ...
  if (colaboradorId) {
    modalSenha.dataset.colaboradorId = colaboradorId;
  } else {
    delete modalSenha.dataset.colaboradorId;
  }
}

// Função para fechar modal senha e limpar estado
